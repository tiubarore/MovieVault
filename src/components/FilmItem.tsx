...
import { rimuoviFilm, toggleFavorite, toggleWatched, updateRating, type Film } from "../redux/filmsSlice";
import StarRating from "../components/StarRating";
import { type AppDispatch } from "../redux/store";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faHeart as fasHeart } from '@fortawesome/free-solid-svg-icons';
import { faHeart as farHeart, faTrashCan as farTrashCan, faEye as farEye, faEyeSlash as farEyeSlash } from '@fortawesome/free-regular-svg-icons';
            ...
            <>
              ...
              <div className="bg-white/5 rounded-full p-2 hover:bg-white/10 transition-all duration-300">
                <StarRating 
                  ...
                  onRatingChange={(newRating) => dispatch(updateRating({ id: film.id, rating: newRating }))} 
                />
              </div>
            </>
          )}
